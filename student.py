...
class student:
    def __init__(self, root):
        ...
        lbl_roll=Label(manage_frame,text="Roll No.",bg="crimson",fg="white",font=("times new roman",17,"bold"))
        lbl_roll.grid(row=1,column=0,padx=10,pady=10,sticky="w")

        txt_roll=Entry(manage_frame,textvariable=self.Roll_No_var,width=23,font=("times new roman",17,"bold"),bd=5,relief=GROOVE)
        ...
        txt_name=Entry(manage_frame,textvariable=self.name_var,width=23,font=("times new roman",17,"bold"),bd=5,relief=GROOVE)
        txt_name.grid(row=2,column=1,padx=10,pady=10,sticky="w")

        lbl_email=Label(manage_frame,text="E-MAIL",bg="crimson",fg="white",font=("times new roman",17,"bold"))
        lbl_email.grid(row=3,column=0,padx=10,pady=10,sticky="w")

        txt_email=Entry(manage_frame,textvariable=self.email_var,width=23,font=("times new roman",17,"bold"),bd=5,relief=GROOVE)
        ...
        #txt_gender=Entry(manage_frame,font=("times new roman",20,"bold"),bd=5,relief=GROOVE)
        ...
        lbl_contact=Label(manage_frame,text="CONTACT",bg="crimson",fg="white",font=("times new roman",17,"bold"))
        lbl_contact.grid(row=5,column=0,padx=10,pady=10,sticky="w")

        txt_contact=Entry(manage_frame,textvariable=self.contact_var,width=23,font=("times new roman",17,"bold"),bd=5,relief=GROOVE)
        txt_contact.grid(row=5,column=1,padx=10,pady=10,sticky="w")

        lbl_dob=Label(manage_frame,text="D.O.B",bg="crimson",fg="white",font=("times new roman",17,"bold"))
        lbl_dob.grid(row=6,column=0,padx=10,pady=10,sticky="w")

        txt_dob=Entry(manage_frame,textvariable=self.dob_var,width=23,font=("times new roman",17,"bold"),bd=5,relief=GROOVE)
        txt_dob.grid(row=6,column=1,padx=10,pady=10,sticky="w")

        lbl_address=Label(manage_frame,text="ADDRESS",bg="crimson",fg="white",font=("times new roman",17,"bold"))
        lbl_address.grid(row=7,column=0,padx=10,pady=10,sticky="w")

        #txt_address=Entry(manage_frame,font=("times new roman",20,"bold"),bd=5,relief=GROOVE)
        #txt_address.grid(row=7,column=1,padx=10,pady=10,sticky="w")
        self.txt_address=Text(manage_frame,width=26,height=4,font=("",15))
        self.txt_address.grid(row=7,column=1,padx=10,pady=10,sticky="w")


#======BUTTON FRAME=======
        btn_frame=Frame(manage_frame,bd=4,relief=RIDGE,bg="crimson")
        btn_frame.place(x=20,y=530,width=450)
        ...
        lbl_search=Label(detail_frame,text="SEARCH BY",bg="crimson",fg="white",font=("times new roman",17,"bold"))
        lbl_search.grid(row=0,column=0,padx=10,pady=10,sticky="w")

        combo_search=ttk.Combobox(detail_frame,textvariable=self.search_by,width=12,font=("times new roman",19,"bold"),state='readonly')
        combo_search['values']=("roll_no","name","contact")
        combo_search.grid(row=0,column=1,padx=10,pady=10,sticky="w")

        txt_search=Entry(detail_frame,textvariable=self.search_txt,width=15,font=("times new roman",12,"bold"),bd=5,relief=GROOVE)
        txt_search.grid(row=0,column=2,padx=10,pady=10,sticky="w")
        
        searchbtn=Button(detail_frame,text="SEARCH",width=12,command=self.search_data).grid(row=0,column=3,padx=10,pady=10)
        showbtn=Button(detail_frame,text="SHOW",width=12,command=self.fetch_data).grid(row=0,column=4,padx=10,pady=10)
